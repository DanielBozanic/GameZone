...
def get_all():
    ...
    try:
        r = requests.get(processor_api_routes.BASE + processor_api_routes.API + processor_api_routes.GET_ALL +
...
def filter():
    ...
    data = request.json
    try:
        r = requests.post(processor_api_routes.BASE + processor_api_routes.API + processor_api_routes.FILTER +
