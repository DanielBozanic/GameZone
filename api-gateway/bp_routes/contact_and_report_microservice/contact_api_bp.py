...
contact_api_bp.route(contact_api_routes.GET_NUMBER_OF_UNANSWERED_CONTACT_MESSAGES_BY_USER_ID + "/<userId>",
                     methods=['GET'])(get_number_of_unanswered_contact_messages_by_user_id)
...
contact_api_bp.route(contact_api_routes.GET_CONTACT_MESSAGES,
                     methods=['GET'])(get_contact_messages)
